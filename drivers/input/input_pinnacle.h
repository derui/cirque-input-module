...
struct pinnacle_config {
  ...
  bool rotate_90, sleep_en, no_taps, no_secondary_tap, x_invert, y_invert, absolute_mode, rounding_scroll, acceleration;
    ...
    uint16_t rounding_scroll_detection_edge, rounding_scroll_sensitivity;
